...
public class TargetDB {
    ...
    protected Map<String, TargetDetail> readTarget() {
        ...
        try {
            ...
            for (int i = 0; i < array.length(); i++) {
                ...
                TargetDetail TargetDetail = new TargetDetail(tid, targetName, targetContent, startTime, endTime, state, auth, dream, participator, allmission, completemission);
    ...
    public static class TargetDetail {
        String tid, targetName, targetContent, state, auth, startTime, endTime, dream, participator, allmission, completemission;

        TargetDetail(String param1, String param2, String param3, String param4, String param5, String param6, String param7, String param8, String param9, String param10, String param11) {
            ...
            this.allmission = param10;
            this.completemission = param11;
        }
    }
