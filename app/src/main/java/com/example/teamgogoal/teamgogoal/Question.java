...
public class Question extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expandableListView = (ExpandableListView) findViewById(R.id.question_listview);
        ...
        adapter = new ExpandListView_ListAdapter(this,group_list,item_list,item_group2_common_question_content);
